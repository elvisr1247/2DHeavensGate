...
public class Assets {
	...
	public static BufferedImage grass00,grass01,brick,treeTile,rupee,tree,grassSword;
	public static BufferedImage Moonbackground,GateBackground;

	public static BufferedImage[] skeleton,player,attackPlayer,oldman;
	...
	public static void init(){
		...
		SpriteSheet keysIcon
		   = new SpriteSheet(ImageLoader.loadImage("/img/KeyIcons.png"));
...
//	    attackPlayer[2] = playerSheet.crop(64*3, 0, 64, 64);
		...
		keys[0] = keysIcon.crop(0, 0, 30, 30);
...
//		key = ImageLoader.loadImage("/img/key2.0.png");
