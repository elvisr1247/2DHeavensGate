...
public class Creature extends Entity {
	  ...
	  protected boolean isCollidingWithTile = false;
	  ...
	  public void move() {		 
		    //updates entity collision as player moves
		  	if(!collisionWithEntity(xMove,0f))moveX();
			if(!collisionWithEntity(0f,yMove))moveY();  
	  }
...
//	              isCollidingWithTile = false;
				  ...
				  x = (float) (tx * game.tileSize - bounds.x - bounds.width - 0.1);
			  }
...
//			  		isCollidingWithTile = false;
				  ...
				  isCollidingWithTile = true;
				  x = tx * game.tileSize + game.tileSize - bounds.x;
			  }
	  	 ...
	  	 if(yMove > 0) {//top movement
	  		 ...
	  		 if(!collisionWithTile((int)(x+bounds.x)/game.tileSize,ty)&&
	  			 ...
	  			 y+=yMove;
	  			 	...
	  			 	y = (float) (ty * game.tileSize - bounds.y - bounds.height - 0.1);
	  		 }
			  ...
			  ty = (int)(y + yMove + bounds.y)/game.tileSize;
		  		 if(!collisionWithTile((int)(x+bounds.x)/game.tileSize,ty)&&
		  			 ...
		  			 y = ty * game.tileSize + game.tileSize - bounds.y;
		  		}
		  }
